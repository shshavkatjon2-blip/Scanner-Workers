...
const expectedVersion = "v1.8.0-100x-scale-controls-20260627";
...
function main() {
  ...
  for (const file of [
    ...
    "env.scanner.100x.template",
    "render.yaml",
    "render.100x-64-workers.yaml",
  ...
  assertIncludes(errors, "render.100x-64-workers.yaml", "vidipay-payment-scanner-100x-63", "64th scanner worker");
  assertIncludes(errors, "RUN_100X_SCALING_SQL_2026-06-27.sql", "claim_pending_payment_orders_sharded", "100x sharded SQL function");
  assertIncludes(errors, "env.scanner.100x.template", "PAYMENT_SCANNER_SHARD_COUNT=64", "100x scanner shard count env");
